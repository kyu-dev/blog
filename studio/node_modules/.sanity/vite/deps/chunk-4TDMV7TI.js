...
import {
  ...
  usePortal,
  useToast
} from "./chunk-ANBMT5XW.js";
import {
  require_dist
} from "./chunk-6BKE37EU.js";
import {
  require_jsx_runtime
} from "./chunk-KJWISR7I.js";
import {
  require_react
...
// node_modules/.pnpm/sanity@3.89.0_@emotion+is-prop-valid@1.2.2_@types+node@22.15.21_@types+react@18.3.22_im_a81e1bea9f6e0990b34fbe0bbb3d8d38/node_modules/sanity/lib/_chunks-es/StructureToolProvider.mjs
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-7MQ3J2ZI.js")
});
...
// node_modules/.pnpm/sanity@3.89.0_@emotion+is-prop-valid@1.2.2_@types+node@22.15.21_@types+react@18.3.22_im_a81e1bea9f6e0990b34fbe0bbb3d8d38/node_modules/sanity/lib/_chunks-es/pane.mjs
...
// node_modules/.pnpm/scrollmirror@1.2.2/node_modules/scrollmirror/dist/ScrollMirror.modern.js
...
var DocumentPaneProvider = (0, import_react2.memo)((props) => {
  const {
    ...
    selectedPerspectiveName,
    initialFocusPath: params.path ? fromString(params.path) : EMPTY_ARRAY$A,
...
var addSelectedStateToMenuItems = (options) => {
  ...
  return menuItems == null ? void 0 : menuItems.map((item) => {
    ...
    return ((_a = item.params) == null ? void 0 : _a.layout) ? {
      ...
      ...item,
      selected: (0, import_isEqual.default)(sortOrderRaw == null ? void 0 : sortOrderRaw.by, ((_d = item == null ? void 0 : item.params) == null ? void 0 : _d.by) || EMPTY_ARRAY$A)
    } : {
      ...item,
      selected: false
    };
...
var PaneContainer = (0, import_react2.memo)(function(props) {
  const $ = (0, import_react_compiler_runtime.c)(36), {
    ...
    menuItems,
    options
  } = pane2, defaultLayout = t0 === void 0 ? "default" : t0, initialValueTemplates = t1 === void 0 ? EMPTY_ARRAY$A : t1, {
    defaultOrdering: t2,
    filter: filter2
  } = options, defaultOrdering = t2 === void 0 ? EMPTY_ARRAY$A : t2, params = useShallowUnique(options.params || EMPTY_RECORD), sourceName = pane2.source;
  let t3;
  bb0: {
    let t42;
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-TPP6U7JP.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-4TDMV7TI.js.map
