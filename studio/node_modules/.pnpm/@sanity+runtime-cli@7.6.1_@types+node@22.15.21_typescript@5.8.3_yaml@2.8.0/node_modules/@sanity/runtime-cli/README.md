...
running command...
$ sanity-run (--version)
@sanity/runtime-cli/7.6.1 linux-x64 node-v22.15.0
...
_See code: [src/commands/blueprints/add.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/blueprints/add.ts)_
...
_See code: [src/commands/blueprints/config.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/blueprints/config.ts)_
...
_See code: [src/commands/blueprints/deploy.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/blueprints/deploy.ts)_
...
_See code: [src/commands/blueprints/destroy.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/blueprints/destroy.ts)_
...
_See code: [src/commands/blueprints/info.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/blueprints/info.ts)_
...
_See code: [src/commands/blueprints/init.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/blueprints/init.ts)_
...
_See code: [src/commands/blueprints/logs.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/blueprints/logs.ts)_
...
_See code: [src/commands/blueprints/plan.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/blueprints/plan.ts)_
...
_See code: [src/commands/functions/dev.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/functions/dev.ts)_
...
_See code: [src/commands/functions/env/add.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/functions/env/add.ts)_
...
_See code: [src/commands/functions/env/list.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/functions/env/list.ts)_
...
_See code: [src/commands/functions/env/remove.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/functions/env/remove.ts)_
...
_See code: [src/commands/functions/logs.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/functions/logs.ts)_
...
_See code: [src/commands/functions/test.ts](https://github.com/sanity-io/runtime-cli/blob/v7.6.1/src/commands/functions/test.ts)_
