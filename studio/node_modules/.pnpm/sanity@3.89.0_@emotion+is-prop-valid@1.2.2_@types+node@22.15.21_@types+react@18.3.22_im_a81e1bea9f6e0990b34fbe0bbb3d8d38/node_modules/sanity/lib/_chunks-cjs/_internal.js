...
const debug = debug__default.default("sanity:backup"), DEFAULT_DOWNLOAD_CONCURRENCY = 10, MAX_DOWNLOAD_CONCURRENCY = 24, helpText$G = `
Options
...
}, DEFAULT_LIST_BACKUP_LIMIT = 30, helpText$E = `
Options
...
const yellow = (str) => `\x1B[33m${str}\x1B[39m`, helpText$u = `
Options
...
}, defaultApiVersion = "v2022-06-01", helpText$n = `
...
const description$6 = "Downloads and validates all document specified in a workspace", helpText$m = `
Options
...
}, description$5 = "Extracts the studio configuration as one or more JSON manifest files.", helpText$h = `
...
const helpText$a = "", listMigrationCommand = {
  name: "list",
  group: "migration",
  signature: "",
  helpText: helpText$a,
...
}, description$3 = "Deploy schema documents into workspace datasets.", helpText$6 = `
**Note**: This command is experimental and subject to change.
...
const description$1 = "Lists all schemas in the current dataset.", helpText$4 = `
**Note**: This command is experimental and subject to change.
