...
`, DocumentListPane = memo(function(props) {
  ...
  return useReconnectingToast(!connected), /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Box, { paddingX: 3, paddingBottom: 3, children: /* @__PURE__ */ jsx(Tooltip, { disabled: connected, placement: "bottom-end", content: t("panes.document-list-pane.reconnecting"), children: /* @__PURE__ */ jsx(TextInput, { "aria-label": t("panes.document-list-pane.search-input.aria-label"), autoComplete: "off", border: !1, clearButton: !!searchQuery, readOnly: !!(error || !connected), fontSize: [2, 2, 1], icon: textInputIcon, iconRight: !connected || loadingVariant === "subtle" && !searchInputValue ? DelayedSubtleSpinnerIcon : null, onChange: handleQueryChange, onClear: handleClearSearch, onKeyDown: handleSearchKeyDown, padding: 2, placeholder: t("panes.document-list-pane.search-input.placeholder"), radius: 2, ref: setSearchInputElement, spellCheck: !1, value: searchInputValue }) }) }),
